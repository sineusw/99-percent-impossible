...
gradle=gradle.replace(/versionCode\s+\d+/,'versionCode 9').replace(/versionName\s+"[^"]+"/,'versionName "1.0.8"');
...
console.log('Android configured: API 36 + versionCode 9 + billing + WebView audio playback + voice transport fix');
