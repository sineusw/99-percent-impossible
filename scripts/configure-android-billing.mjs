...
gradle=gradle.replace(/versionCode\s+\d+/,'versionCode 5').replace(/versionName\s+"[^"]+"/,'versionName "1.0.4"');
...
console.log('Android billing configured for com.pettygamesstudios.ninetynineimpossible: API 36 + versionCode 5 + BILLING permission + Play Billing 9.1.0 + N99Billing plugin');
