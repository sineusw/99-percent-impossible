/* 99% IMPOSSIBLE — HTML5 Audio SFX Engine v4.0.2 (Strict 3-Asset Minimal)
   Exactly 3 game outcomes: fail, win, perfect. No start/tick/go/tap hooks.
   Global mute silences gameplay outcome SFX too.
   iOS: all outcomes use the preloaded/reusable audio bank; avoid creating fresh Audio at result time. */
(()=>{
'use strict';
